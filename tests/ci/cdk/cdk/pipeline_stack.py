...
class AwsLcCiPipeline(Stack):
    def __init__(
        ...
        code_pipeline.artifact_bucket.add_to_resource_policy(
            iam.PolicyStatement(
                effect=iam.Effect.ALLOW,
                resources=[code_pipeline.artifact_bucket.arn_for_objects("*")],
        ...
        setup_stage = SetupStage(
            self,
            "Setup",
            # pipeline_role_arn=code_pipeline.role.role_arn,
